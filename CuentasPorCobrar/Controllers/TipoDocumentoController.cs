...
namespace CuentasPorCobrar.Controllers
{
    public class TipoDocumentoController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdTipoDocumento,Descripcion,Estado")] TipoDocumento tipoDocumento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdTipoDocumento,Descripcion,Estado")] TipoDocumento tipoDocumento)
        {
            if (ModelState.IsValid)
            {
